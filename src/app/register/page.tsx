...
useEffect(()=>{
  ...
  {/* RIGHT PANEL */}
  <div className="flex flex-col justify-between items-center w-full max-lg:bg-[url('/loginbg.jpeg')] max-lg:bg-cover max-lg:bg-center max-lg:bg-no-repeat min-h-full bg-white 
