const InputField: React.FC<{
  ...
  <div className={`relative w-full ${className ?? ""}`}>
    ...
    `}>
      {/* Dot indicator when has value */}
      {value && !error && (
        <span className="absolute left-3 w-1.5 h-1.5 rounded-full bg-[var(--color-primary)] shrink-0 pointer-events-none" />
      )}
